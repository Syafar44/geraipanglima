...
const Contact = () => {
  ...
  return (
    <>
      ...
      <section className="hero h-52 lg:h-72">
        ...
        <div className="hero-content text-neutral-content text-center">
          <div>
            ...
            <p className="lg:text-xl font-bold text-black">
      ...
      <section>
        <div className="mx-5 lg:mx-44 xl:mx-80 text-center mb-5 lg:mb-20">
          <div className="text-sm lg:text-base">
            ...
            <p className="pb-2 lg:py-3 text-gray-600 font-bold">
              Senin - Sabtu Pukul 08.00 - 17.00 WIB (Kecuali Hari Libur
              Nasional)
            </p>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-5 text-sm xl:text-xl font-bold">
              <div>
      ...
      <section className="mx-5 lg:mx-44 2xl:mx-80 border shadow-xl rounded-lg p-10">
        ...
        <subsection className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="card bg-base-100 image-full w-auto h-[17rem] -mx-5 lg:-mx-0 shadow-xl hover:scale-105 transition ease-in-out">
            <figure>
              <img
                className="scale-110 xl:scale-[2]"
